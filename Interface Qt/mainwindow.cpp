...
void MainWindow::sendPID(){
    ...
    double goal = ui->angle_pos_lineEdit->text().toDouble();
    double Kp = ui->angle_kp_lineEdit->text().toDouble();
    double Ki = ui->angle_ki_lineEdit->text().toDouble();
    double Kd = ui->angle_kd_lineEdit->text().toDouble();
...
void MainWindow::sendPID_x(){
    // Fonction SLOT pour envoyer les paramettres de pulse
    double goal = ui->x_pos_lineEdit->text().toDouble();
    double Kp = ui->x_kp_lineEdit->text().toDouble();
    double Ki = ui->x_ki_lineEdit->text().toDouble();
    double Kd = ui->x_kd_lineEdit->text().toDouble();
